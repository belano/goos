...
initialize_data_dir() {
  ...
  echo "Installing restAPI plugin..."
  sudo -HEu ${OPENFIRE_USER} cp /tmp/restAPI.jar ${OPENFIRE_DATA_DIR}/plugins/

  # overwrite openfire.xml
  sudo -HEu ${OPENFIRE_USER} cp /tmp/openfire.xml ${OPENFIRE_DATA_DIR}/conf/
